...
SELECT * -- selecione qualquer coisa
   FROM aluno; -- da tabela aluno

 SELECT nome -- selecionar apenas a coluna nome
  FROM aluno; -- da tabela aluno
  
 SELECT nome, -- seleciona duas colunas
 		idade -- produzindo uma subtabela
  FROM aluno; -- de aluno
 ...
 SELECT nome, 
 		idade, -- criamos uma associação para os nomes
		matriculado_em as quando_se_matriculou
  FROM aluno;
  
 SELECT nome as "Nome do Aluno", -- melhora o layout da apresentação
 		idade,
		matriculado_em as quando_se_matriculou
  FROM aluno;  
 ...
 SELECT nome as "Nome do Aluno",
 		idade,
		matriculado_em as "Data de Matrícula"
  FROM aluno; 